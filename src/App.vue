...
<template>
  ...
  <main id="about">
    <div class="container">
      <img class="avatar" src="https://placehold.co/200" alt="Avatar" />
      <div class="text">
        <h1>
    ...
    <div class="intro">
      ...
      <p>
        ...
        I'm currently looking for new opportunities, so feel free to contact me if you think I could be a good fit for your team!
      </p>
    </div>
  </main>
